...
<main>
    <div class="text-center ml-3 my-3">
        <form:form method="POST" modelAttribute="hhForm">
            <h2><s:message code="editProfile"/></h2>

            <form:input path="first_name" type="text" hidden="hidden" value="${partOfHhForm.first_name}"/>
            <form:input path="last_name" type="text" hidden="hidden" value="${partOfHhForm.last_name}"/>
            <form:input path="username" type="text" hidden="hidden" value="${partOfHhForm.first_name}_${partOfHhForm.last_name}"/>
            <h3>Let's confirm acc for ${partOfHhForm.first_name}_${partOfHhForm.last_name} </h3>
            <div class="text-center ml-3 my-3">
            ...
            <div class="text-center ml-3 my-3">
                ...
                <form:input path="password_confirm" type="password" placeholder=""/>
                <form:errors path="password"/>
                    ${passwordError}
            </div>
            <div class="text-center ml-3 my-3">
                <h6><s:message code="role"/> </h6>
